...
function get_random_text(){
  // Get a random index
  random_index1 = Math.floor(Math.random() * text_array.length);
  random_index2 = Math.floor(Math.random() * text_array.length); 
  // Get an image at the random_index
  selected_text1 = text_array[random_index1]
  selected_text2 = text_array[random_index2]
  // Display the image
    if(selected_text1 =="蘆筍"){
        Match = [
            '干貝'
        ]
        ...
        document.getElementById('textbox').textContent ='曖曖遠人村，依依墟里煙。狗吠深巷中，雞鳴桑樹顛。'
    }
